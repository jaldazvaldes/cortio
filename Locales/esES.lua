...
L["OPT_ONLY_DUNGEONS"] = "Mostrar Solo en Mazmorras/Raid"
L["OPT_ONLY_DUNGEONS_DESC"] = "El panel solo será visible automáticamente cuando estés dentro de una Mazmorra, Grupo, o Banda (y en Modo Prueba)."
